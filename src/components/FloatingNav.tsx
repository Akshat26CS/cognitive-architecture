...
import { getGameState, getActiveUser } from '../lib/gameState';
    ...
    <>
      ...
      >
        {activeUser ? (
          ...
          <>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-rose-500 to-violet-500 flex items-center justify-center text-sm font-bold text-white shadow-[0_0_15px_rgba(244,63,94,0.4)] group-hover:scale-105 transition-transform animate-pulse">
              🔑
            </div>
            <div className="flex flex-col items-start">
              <span className="text-[10px] uppercase font-mono text-white/50 tracking-widest leading-none">Access</span>
              <span className="text-xs font-bold text-rose-400 leading-none mt-1">LOGIN</span>
            </div>
          </>
        )}
      </button>
